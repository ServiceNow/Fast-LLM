...
def test_decide_window_size():
    ...
    attention._config = TransformerLayerConfig(window_size=512, max_window_layers=2)
    ...
    attention._config = TransformerLayerConfig(window_size=512, max_window_layers=None)
    assert attention._decide_window_size() == 512
