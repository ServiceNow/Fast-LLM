...
@pytest.mark.slow
def test_model_dp2_timeout(gpu_lock):
...
@pytest.mark.slow
@pytest.mark.depends(on=["test_model"])
def test_model_dp2_z2(gpu_lock):
...
@pytest.mark.slow
@pytest.mark.depends(on=["test_model"])
def test_model_dp2_z3(gpu_lock):
