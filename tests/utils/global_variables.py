...
DATASET_PATH = DATASET_CACHE / "common_dataset/dataset.fast_llm_dataset"
DATASET_WITH_SPANS_PATH = DATASET_CACHE / "dataset_with_spans/dataset.fast_llm_dataset"
...
MODEL_DATASET_PATH = DATASET_CACHE / "model_dataset/dataset.fast_llm_dataset"
