...
from fast_llm.data.preparator.gpt_memmap.prepare import GPTMemmapDatasetPreparatorConfig, GPTMemmapDatasetPreparator
...
if __name__ == "__main__":
    ...
    if args.prepare_config:
        with open(args.prepare_config, 'r') as f:
