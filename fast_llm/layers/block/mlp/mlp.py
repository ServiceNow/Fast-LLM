...
from fast_llm.engine.config_utils.tensor_space import ConcatenatedTensorDim, TensorDim
...
class MLPBase[ConfigType: MLPConfig](BlockLayer[ConfigType]):
    def __init__(
        ...
        lr_scale = self._config.per_layer_lr_scale[block_index] if self._config.per_layer_lr_scale else None
        ...
        self.layer_2 = self._config.layer_2.get_layer(
            intermediate_2_dim,
            hidden_dim,
            auto_bias_grad_accumulation=self._parallel_dim.size > 1,
