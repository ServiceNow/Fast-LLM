...
from fast_llm.engine.checkpoint.external import HuggingfaceStateDictCheckpointSaver
...
class ConversionConfig(RunnableConfig):
    ...
    def run(self, model_config_class: type["FastLLMModelConfig"] | str):
        ...
        if self.layers_per_step is None:
            ...
            converter_class = model_config_class.get_saver_class(self.output.format)
            # TODO: Support other types?
            assert issubclass(converter_class, HuggingfaceStateDictCheckpointSaver)
