...
from fast_llm.data.sample.language_model import _crop_optional, _merge_optional
...
class PipelineRLBatch(Batch):
    ...
    @classmethod
    def from_samples(cls, samples: typing.Iterable[PipelineRLSample]) -> typing.Self:
        return cls(
    ...
    def to_samples(self) -> list[PipelineRLSample]:
        return [
            PipelineRLSample(tokens, loss_masking_spans, chosen_spans, rejected_spans)
