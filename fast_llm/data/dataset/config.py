...
from fast_llm.config import Config, Field, FieldHint, check_field, config_class, FieldVerboseLevel
...
class SamplingConfig(Config):
    ...
    @property
    def updates(self) -> typing.Dict[str, typing.Any]:
        return {key: value for key, value in self.to_serialized(verbose=FieldVerboseLevel.everything).items() if
                value is not None}
