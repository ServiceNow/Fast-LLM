...
class GPTData(AbstractData):
    ...
    _sampled_dataset: dict[PhaseType, SampledDataset]
    ...
    def setup(self, distributed: Distributed, samples_per_phase: dict[PhaseType, int]):
        ...
        # TODO: experiment_directory can be none.
        self._cache_directory = run.experiment_directory / "dataset_cache"

        self._sampled_dataset = self._config.dataset.build_split_sampled(self)
    ...
    def get_iterator(
        ...
        *,
        ...
        Assert.incl(phase, self._sampled_dataset)
